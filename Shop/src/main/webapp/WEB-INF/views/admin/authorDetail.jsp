...
<link rel="stylesheet" href="../resources/css1/admin/authorDetail.css">
<script
	...
	<div class="admin_content_wrap">
		...
		<div class="admin_content_main">
			<div class="form_section">
				...
				<div class="form_section_content">
					<input class="input_block" name="authorId" readonly="readonly" value="<c:out value='${authorInfo.authorName}'></c:out>">
				</div>
			</div>
