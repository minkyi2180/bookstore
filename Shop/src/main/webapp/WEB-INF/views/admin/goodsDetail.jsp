...
<link rel="stylesheet" href="../resources/css1/admin/goodsDetail.css">
<script
                    ...
                    <div class="admin_content_main">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content bit">
                    				<textarea name="bookIntro" id="bookIntro_textarea" rows="5" cols="80" disabled>${goodsInfo.bookIntro}</textarea>
                    			</div>
                    		</div>        		
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content bct">
                    				<textarea name="bookContents" id="bookContents_textarea" rows="5" cols="80" disabled>${goodsInfo.bookContents}</textarea>
                    			</div>
                    		</div>
...
<script>
	...
	$.getJSON("/getAttachList", {bookId : bookId}, function(arr){	
		...
		if(arr.length === 0){	
			...
			str += "<img src='../resources/img1/No.png'>";
			str += "</div>";
