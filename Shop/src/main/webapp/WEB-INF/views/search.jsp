...
<link rel="stylesheet" href="../resources/css1/search.css">
<script
					...
					<table class="type_list">
						...
						<tbody id="searchList>">
							<c:forEach items="${list}" var="list">
								<tr>
									<td class="image">
										<div class="image_wrap" data-bookid="${list.imageList[0].bookId}" data-path="${list.imageList[0].uploadPath}" data-uuid="${list.imageList[0].uuid}" 
		...
		<div class="footer">
			<div class="footer_container">
				...
				<div class="footer_right">
					(주) VamBook 대표이사 : 나
					<br>
					사업자 등록 번호 : 000-0000-00
					<br>
					대표전화 : 0000-0000(발신자 부담 전화)
					<br>
					COPYRIGHT(C) <strong>www.naver.com</strong>
					ALL RIGTHS RESERVED
				</div>
	...
	$(document).ready(function(){
		...
		$(".image_wrap").each(function(i, obj){
			...
			$(this).find("img").attr('src', '/display?fileName=' + fileCallPath);
				...
				$(this).find("img").attr('src', '/resources/img1/No.png');
			}
		});
	});
